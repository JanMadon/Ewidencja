<template>
    <AuthenticatedLayout>
        <template #header>
            <h1 class="font-semibold text-2xl text-gray-800 leading-tight">User requests</h1>
        </template>
        ...
        <div class="flex overflow-auto">
            ...
            <table v-else class="min-w-full w-[900]">
                ...
                <tbody>
                    ...
                    :class="{'bg-red-100': userRequests.status === 'rejected', 'bg-green-100': userRequests.status === 'accpeted'} " >
